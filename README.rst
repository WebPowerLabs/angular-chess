...
.. code-block:: bash
    ...
    heroku run python angular-chess/manage.py syncdb --noinput --settings=config.settings
    heroku run python angular-chess/manage.py migrate --settings=config.settings
    heroku run python angular-chess/manage.py collectstatic --settings=config.settings
